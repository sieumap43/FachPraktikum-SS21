...
parser.add_argument('--src_dir', type=str, default='columbia',
                    help='source directory (assuming the parent directory is GazeML/datasets')
parser.add_argument('test_dir', type=str, default='columbia',
                    help='validation directory (assuming the parent directory is GazeML/datasets')
...
if __name__ == '__main__':
    ...
    # test data
    img_paths = glob(os.path.join(datasets_dir, params.test_dir, '*.jpg'))
    img_paths.sort()
